...
0. Прочитай второй мозг — `~/Library/Mobile Documents/iCloud~md~obsidian/Documents/SECOND BRAIN/INDEX.md`
   ...
   > Этот раздел — ЕДИНСТВЕННЫЙ источник протокола старта сессии.
   > `docs/WORKING_RULES.md` §0 ссылается сюда и шаги не повторяет: пока список
   > жил в двух местах, они разошлись (7 шагов против 4), и какой исполнится —
   > зависело от того, какой файл сессия открыла первой.
