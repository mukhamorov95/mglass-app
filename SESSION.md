...
Следующая фаза (отложено): учёт закупок (статусы заказано/приехало, ₽, склад, разблокировка этапа по приходу материала); агрегация для других станций по аналогии с резкой.
