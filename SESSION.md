...
- Комплект блоками (петли/труба/крепление трубы/профиль/заглушки/уплотнители); П-профиль ОДИН на все стороны (общий раскрой)
- Карточки позиций с сайта поставщика: lib/supplier/enrichParse.ts + /api/admin/supplier-catalog/enrich, фото и характеристики
...
PR #226 и #233 ВЛИТЫ в main — прод деплоится Vercel. Владелец дал право мержить самому, не спрашивая.
Открытый вопрос владельцу: «заглушка сверху» — над проёмом двери (так считает сейчас) или верхний профиль целиком.
