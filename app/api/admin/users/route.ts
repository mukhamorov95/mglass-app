...
export async function GET() {
  ...
  const full = await db
    .from('users')
    .select('id,email,name,role,active,manager_code,password_plain,see_all_orders,can_view_all_deals,amo_user_id,max_discount_percent,can_delete,permissions,created_at')
