...
const KP_SCHEMA = {
  ...
  properties: {
    title:        { type: 'string', description: 'Заголовок КП — тип и модель изделия заглавными, напр. «ДУШЕВАЯ КАБИНА CRYSTAL VISION»' },
...
export async function POST(req: Request) {
  ...
  const sys = [
    ...
    'ничего не выдумывай, не проставляй цены и суммы, если их не назвали. Числа приводи',
    'к числовому виду (без пробелов и «₽»). Если передан existing — это уже заполненный КП,',
    'обнови его новой репликой: добавляй/исправляй названное, остальное оставь как есть.',
  ].join(' ')
