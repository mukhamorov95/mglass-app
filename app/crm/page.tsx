...
// Зоны и этапы — канон SYSTEM.md (менять только вместе с salesMonitor)
const ZONES: { zone: string; tone: string; stages: string[] }[] = [
  { zone: 'Квалификация', tone: 'text-blue-700', stages: [
    'Получена новая заявка', 'Назначен ответственный', 'Проработка', 'Разговор состоялся', 'Долгострой', 'Готов купить',
  ]},
  ...
  { zone: 'Производство', tone: 'text-emerald-700', stages: [
    'Оплата сделана, чертежи не готовы', 'Оплата получена, проверка чертежей', 'Счёт оплачен', 'Заказ в работе',
    'Готово к монтажу', 'Монтаж назначен', 'Монтаж начат / в процессе', 'Рекламация', 'Оплата остатка', 'Оплата дизайнером',
  ]},
]
