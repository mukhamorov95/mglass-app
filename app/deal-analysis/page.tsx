...
— Что сказать / написать клиенту прямо сейчас`,
  ...
  return (
    <div className="max-w-[720px] mx-auto px-6 py-8">
      <div className="mb-6">
        <h1 className="text-[18px] font-semibold text-ink tracking-tight">Анализ сделки</h1>
        <p className="text-[13px] text-muted mt-0.5">Опиши ситуацию — получи план действий по конкретному клиенту</p>
      </div>
      ...
      <div className="bg-surface border border-line rounded-xl p-5 space-y-4">
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full rounded-lg border border-line px-3 py-2.5 text-[13px] text-ink placeholder:text-faint focus:outline-none focus:border-muted resize-none"
          />
        </div>
      ...
      {result && (
        <div className="bg-surface border border-line rounded-xl p-5 mt-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-[13px] font-semibold text-ink">Анализ и план действий</h3>
            <button onClick={copy}
