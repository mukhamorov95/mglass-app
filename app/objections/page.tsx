...
— Как перевести в следующий шаг (замер / расчёт / встреча)`,
  ...
  return (
    <div className="max-w-[720px] mx-auto px-6 py-8">
      <div className="mb-6">
        <h1 className="text-[18px] font-bold text-[#111110] tracking-tight">Работа с возражениями</h1>
        <p className="text-[13px] text-[#8a8a85] mt-0.5">Выбери возражение — получи готовый скрипт ответа</p>
      </div>
      ...
      <div className="bg-white border border-[#e4e4e0] rounded-xl p-5 space-y-4">
        ...
        <div>
          <label className="block text-[11px] font-bold text-[#9a9a95] uppercase tracking-widest mb-2">
            Детали ситуации <span className="font-normal normal-case text-[#c4c4be]">(необязательно)</span>
          </label>
      ...
      {result && (
        <div className="bg-white border border-[#e4e4e0] rounded-xl p-5 mt-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-[13px] font-semibold text-[#111110]">Скрипт ответа</h3>
            <button onClick={copy}
