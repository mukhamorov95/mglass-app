      ...
      <div className="px-4 pt-4 max-w-[720px] space-y-5">
        ...
        <div className="bg-white rounded-xl border border-[#e4e4e0] px-4 py-4">
          ...
          <TabRow icon="✅" name="Мои задачи" who="мастер — главный экран">
            ...
            Красное горит, жёлтое — срок близко. Здесь кнопки <Btn>Взял в работу</Btn>, <Btn tone="green">Готово</Btn>, <Btn tone="red">Проблема</Btn>.
          </TabRow>
          ...
          <TabRow icon="📅" name="Пул на сегодня" who="начальник">
            Весь объём цеха на сегодня по станциям: кто что делает, что свободно, где горят проблемы.
          </TabRow>
          <TabRow icon="🗓️" name="Обзор" who="начальник">
            Два вида: «По срокам» — что горит сегодня/завтра; «Матрица» — весь цех одной таблицей заказ × этапы.
          </TabRow>
          <TabRow icon="🏭" name="Станции" who="начальник, резчик">
            Очереди по станциям. Резчику здесь удобнее всего: детали собраны в партии по материалу и толщине.
          </TabRow>
          ...
          <TabRow icon="📦" name="Материал" who="Бекмурза">
            Проверка материала под новые заказы: «есть» — резка открыта; «нет» — заявка на закупку создаётся сама, резка заблокирована до прихода.
          </TabRow>
