      ...
      <div className="px-4 pt-4 max-w-[720px] space-y-5">
        ...
        <div className="bg-white rounded-xl border border-[#e4e4e0] px-4 py-4">
          <div className="flex items-center gap-2.5 flex-wrap">
            <h2 className="text-[17px] font-bold text-[#111110]">Утро: раздать работу</h2>
            <Who color="bg-amber-600">начальник</Who>
          </div>
          <Steps items={[
        ...
        <div className="bg-white rounded-xl border border-[#e4e4e0] px-4 py-4">
          ...
          <Steps items={[
            ...
            <>Взял деталь — нажми <Btn>Взял в работу</Btn>. Начальник сразу видит на борде, что деталь у тебя.</>,
            ...
            <>Что-то не так (скол, не тот размер, нет материала, станок встал) — нажми <Btn tone="red">Проблема</Btn> и выбери причину.
              Это не жалоба: начальник увидит сразу и решит — так мы не теряем день.</>,
          ]} />
