      ...
      <div className="px-4 pt-4 max-w-[720px] space-y-5">
        ...
        <div className="bg-white rounded-xl border border-[#e4e4e0] px-4 py-4">
          ...
          <TabRow icon="✅" name="Мои задачи" who="мастер — главный экран">
            ...
            Красное горит, жёлтое — срок близко. Раскрыл карточку заказа — он сам отметился «в работе», отдельно жать ничего не надо.
            Кнопки: <Btn tone="green">Готово</Btn>, <Btn tone="red">Переделать</Btn> (брак — деталь вернётся в очередь на нужный этап),
          ...
          <TabRow icon="📈" name="Метрики цеха" who="начальник, владелец">
            Выработка по дням и станциям, отгрузка в срок и время на изделие — считается по интервалу между твоими отметками «Готово».
          </TabRow>
          <TabRow icon="👥" name="Кто что делал" who="весь цех">
            Кто сколько отметил сегодня, вчера и за неделю, и лента последних отметок. Это не контроль сверху,
            а общая картина смены: видно, что заказ уже кто-то взял.
          </TabRow>
        ...
        <div className="bg-white rounded-xl border border-[#e4e4e0] px-4 py-4">
          ...
          <Steps items={[
            ...
            <>Раскрыл карточку заказа — он отметился «в работе» сам. Все видят, что деталь у тебя, отдельно нажимать ничего не нужно.</>,
            ...
            <>Брак — скол, трещина, царапина, не тот размер → <Btn tone="red">Переделать</Btn> и один тап по причине. Деталь сама вернётся в очередь на тот этап, с которого её надо делать заново. Если материала нет — это отдельная кнопка <Btn tone="red">🛒 Нет мат.</Btn>, заявка уйдёт в закупку.</>,
          ...
          <div className="mt-3 bg-emerald-50 border border-emerald-200 rounded-lg px-3 py-2.5 text-[14px]">
            ✂️ <b>Резчику удобнее через экран станции:</b> открой <Tab>🏭 Резка</Tab> — детали собраны в партии
        ...
        <div className="bg-white rounded-xl border border-[#e4e4e0] px-4 py-4">
          ...
          <Steps items={[
            <>Утро: <Tab>📊 Загрузка</Tab> — где копится работа и что горит по срокам. Горящему заказу ставь «🔥 Срочно» в карточке — у мастеров он взлетит наверх очереди.</>,
            <><Tab>👥 Кто что делал</Tab> — кто вышел и что закрыл. Пустая строка у человека, который на смене, значит он не отмечает, а не что он не работает.</>,
