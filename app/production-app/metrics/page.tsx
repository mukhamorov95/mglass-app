      ...
      <div className="px-5 pt-4 space-y-4 max-w-[1100px]">
        ...
        <div className="bg-white rounded-xl border border-[#e4e4e0] overflow-hidden">
          ...
          <p className="px-4 py-2 text-[10px] text-[#c4c4be]">
            Когда один человек ведёт несколько станций, разделить его время между ними нельзя —
            интервал на каждой включает работу на остальных. Тогда честная мера только по человеку,
            и пустые клетки выше означают именно это, а не сбой.
          </p>
        </div>
