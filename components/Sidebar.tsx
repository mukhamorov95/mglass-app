...
function autoOpenAdmin(pathname: string, mode: ViewMode): string[] {
  ...
  if (mode === 'manager') {
    ...
    if (inSection(pathname, ['/admin/glass-prices', '/admin/mirror-lighting', '/admin/mirror-frames', '/admin/facet', '/admin/materials', '/admin/services', '/admin/hardware', '/admin/shower-hardware', '/admin/loft-rates', '/admin/mirror-frame-rates', '/admin/railing-rates', '/admin/settings', '/admin/suppliers', '/admin/procurement'])) open.push('directories')
