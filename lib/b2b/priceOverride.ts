...
// А11: порог, ниже которого цена уходит на согласование владельцу, — ставка
// margin_min справочника b2b_rates (lib/b2b/rates.ts). Не запрет: менеджер ставит
// любую цену, но такая сделка отмечается и попадает владельцу в отдельную вкладку.
