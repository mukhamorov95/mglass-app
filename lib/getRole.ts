...
export const ROLE_ALLOWED: Record<Role, string[]> = {
  ...
  manager: [
    ...
    // Зеркало, душевая и лофт убирались из доступа 03.09.2026 («не отображает
    // честную картину»: у душевой фурнитура бралась из таблицы, вписанной
    // руками, и занижала). ВЕРНУЛИ 04.09.2026 по просьбе владельца — менеджеры
    // спрашивают, а замены пока нет; на экране душевой висит предупреждение,
    // что фурнитура считается по старой таблице. Лестничное ограждение и скан
    // дизайн-проекта остаются закрытыми.
    '/calculator/shower',
    '/calculator/mirror',
    '/calculator/loft',
    '/configurator',
