...
// 0.85 проверено на 500+ позициях июля (см. lib/autoWasteApply.ts).
// Позже можно завести по материалу: ходовое стекло реюзается почти полностью,
// экзотика и рифлёное направленное — почти нет.
export const DEFAULT_REUSE_RATE = 0.85
